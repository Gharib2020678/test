                ...
                <div class="row">
                    <div class="col">
                        <div class="site-logo-wrap">
                            <div class="site-logo">
                                <a href="index.php"><img src="img/logo.svg" width="100px" alt="Logo"></a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="header-menu d-none d-xl-block">
                            <nav>
                                <div class="ltn__main-menu">
                                    <ul>
                                        <li class="menu-icon"><a href="index.php">الرئيسية</a>
                                                                     
                                        <li class="menu-icon"><a href="shop-grid.php">المنتجات</a>
                                        ...
                                        <li class="special-link"><a href="contact.php">دعنا نتحدث ..!</a></li>
                                    </ul>
                                </div>
                            </nav>
                        </div>
                            ...
                            <ul>
                                <li>
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="account.html">حسابك</a></li>
        ...
        <div class="ltn__utilize-menu-inner ltn__scrollbar">
            ...
            <div class="mini-cart-footer">
                ...
                <div class="btn-wrapper">
                    <a href="cart.php" class="theme-btn-1 btn btn-effect-1">منتجات السلة</a>
                    <a href="cart.php" class="theme-btn-2 btn btn-effect-2">الدفع</a>
                </div>
        ...
        <div class="ltn__utilize-menu-inner ltn__scrollbar">
            ...
            <div class="ltn__utilize-menu">
                <ul>
                    ...
                    <li class="menu-icon"><a href="shop-grid.php">المنتجات</a></li>
                     <li class="menu-icon"><a href="#">عروض الخميس</a></li>
                            ...
                            <div class="col-lg-12 align-self-center">
                                <div class="slide-item-info">
                                    <div class="slide-item-info-inner ltn__slide-animation">
                                        ...
                                        <h6 class="slide-sub-title animated"><img src="img/icons/icon-img/1.png" alt="#"> صارنا اسرع</h6>
                                        <h1 class="slide-title animated ">     جانلكم <br>  بخدمات جديدة </h1>
                                        <div class="slide-brief animated d-none">
                                            <p>تعمل التحليلات التنبؤية على تغيير صناعة العقارات بشكل كبير. في الماضي ، توفير البيانات بشكل سريع</p>
                                        </div>
                                        <div class="btn-wrapper animated">
                                            <a href="shop.html" class="theme-btn-1 btn btn-effect-1 text-uppercase">منتجاتنا  </a>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="ltn__tab-menu ltn__tab-menu-2 ltn__tab-menu-top-right-- text-uppercase text-center">
                        <div class="nav">
                            ...
                            <a data-toggle="tab" href="#liton_tab_3_2" class="">الثلاجة</a>
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="ltn__product-item ltn__product-item-3 text-center">
                                            ...
                                            <div class="product-info">
                                                ...
                                                <h2 class="product-title"><a href="product-details.html">اسم المنتج</a></h2>
                                                <div class="product-price">
                                                    <span>ريال78.00</span>
                                                    <del>ريال85.00</del>
                                                </div>
                ...
                <div class="row">
                    <div class="col-xl-3 col-md-6 col-sm-6 col-12">
                        <div class="footer-widget footer-about-widget">
                            ...
                            <p>اكتشف غيث وتمتع بتجربة تسوق استثنائية، عروض طوال العام وتشكيلتنا الواسعة، تجد كل ما تحتاجه بأفضل سعر</p>
                            <div class="footer-address">
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        <div class="footer-address-info">
                                            <p><a href="tel:+0123-456789">0563717972</a></p>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="footer-address-icon">
