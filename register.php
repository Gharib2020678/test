                ...
                <div class="col-lg-6 offset-lg-3">
                    <div class="account-login-inner">
                        <form action="#" class="ltn__form-box contact-form-box">
                            ...
                            <input type="text"   id ="a"  placeholder="  اسمك الكريم">
                            <input type="text"   id="b"  placeholder="رقم الجوال">
                            <input type="text"  id="c" placeholder="كلمة المرور">
                     
               
                            <div class="btn-wrapper">
                                <button class="theme-btn-1 btn reverse-color btn-block" type="submit" id="enter_reg">انشاء حساب</button>
                            </div>
                        </form>
                        <div class="by-agree text-center">
                        <a href="login.php" title="سجل دخول"> <h4>   اذا لديك حساب || اضغط هنا    </h4> <i class="fab fa-login"></i></a>
                        <p>بعد عملية التسجيل سيتم تحويلك الي سلة المشتريات  </p>
